...
const String tblUserDBs = 'tblUserDBs';

class UserDBFields {
  static final List<String> values = [
    /// Add all fields here
    userDBId, username, nameSurname, email, address, birthyear, genderId,
    countryCityId, picUrl, aboutUser, isUnderAge, lat, lon,
    verificationCode, membershipTypeId, createdAt, deactivatedAt, updatedAt,
    isCoach, isActive,
  ];

  static const String userDBId = 'user_id';
...
///
// @JsonSerializable()
class UserDB extends Equatable {
  final int? userDBId;
  ...
  @override
  String toString() {
    return 'tblUserDBs(user_id: $userDBId, username: $username, name_surname: $nameSurname, mail: $email, address: $address, birth_year: $birthyear, gender_id: $genderId, country_city_id: $countryCityId, pic_url: $picUrl, about_user: $aboutUser, is_under_25: $isUnderAge, lat: $lat, lon: $lon, verification_code: $verificationCode, membership_type_id: $membershipTypeId, created_at: $createdAt, deactivated_at: $deactivatedAt, updated_at: $updatedAt, is_coach: $isCoach, is_active: $isActive)';
  }
}
