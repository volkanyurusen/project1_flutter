...
part of 'consisted_activity_dynamic_with_distance.dart';
...
ConsistedActivityDynamicWithDistance
    _$ConsistedActivityDynamicWithDistanceFromJson(Map<String, dynamic> json) =>
        ConsistedActivityDynamicWithDistance(
...
Map<String, dynamic> _$ConsistedActivityDynamicWithDistanceToJson(
        ConsistedActivityDynamicWithDistance instance) =>
    <String, dynamic>{
