...
class ConversationOfTrainingOfferBody extends StatelessWidget {
  ...
  const ConversationOfTrainingOfferBody({required this.screenWidth, Key? key})
      : super(key: key);
  ...
  AppBody _createAppBody(
    ...
    GroupedTrainingOfferConversationDynamicByUserState state,
  ...
  List<Widget> _generateTrainingOfferConversationColumn(
    ...
    Set<int?> uniqueSetOfTrainingOfferResponseId,
      ...
      List.generate(
        state.groupedTrainingOfferConversationDynamicList.length,
        (index) => _displayConversationOfTrainingOfferBodyArea(
            uniqueSetOfTrainingOfferResponseId, index),
      );

  /// DISPLAY ==========================================================================================================
  ConversationOfTrainingOfferBodyArea
      _displayConversationOfTrainingOfferBodyArea(
    Set<int?> uniqueSetOfTrainingOfferResponseId,
    int index,
  ) =>
          ConversationOfTrainingOfferBodyArea(
  ...
  void _createSetOfTrainingOfferResponseId(
      GroupedTrainingOfferConversationDynamicByUserState state,
      Set<int?> uniqueSetOfTrainingOfferResponseId) {
    for (var element in state.groupedTrainingOfferConversationDynamicList) {
      uniqueSetOfTrainingOfferResponseId
