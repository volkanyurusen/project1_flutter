...
class ChosenConversationOfFindACoachBodyMessageContentArea
    extends StatefulWidget {
  const ChosenConversationOfFindACoachBodyMessageContentArea({Key? key})
      : super(key: key);

  @override
  State<ChosenConversationOfFindACoachBodyMessageContentArea> createState() =>
      _ChosenConversationOfFindACoachBodyMessageContentAreaState();
}

class _ChosenConversationOfFindACoachBodyMessageContentAreaState
    extends State<ChosenConversationOfFindACoachBodyMessageContentArea> {
  ...
  /// BLOC =============================================================================================================
  BlocBuilder<FindACoachMessageDynamicByFindACoachConversationBloc,
  ...
  List<Widget> _generateMessageDateAndContentArea(
    FindACoachMessageDynamicByFindACoachConversationState state,
    int onWhichNumber,
    ...
    if (_scrollController.position.atEdge) {
      if (_scrollController.position.pixels == 0) {
        context
            ...
            .add(LoadFindACoachMessageDynamicByFindACoachConversationEvent(
