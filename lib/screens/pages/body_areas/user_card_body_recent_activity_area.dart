...
class UserCardBodyRecentActivityArea extends StatelessWidget {
  final AppDateFormat _appDateFormat = AppDateFormat();
  final AppFunctions _appFunctions = AppFunctions();

  UserCardBodyRecentActivityArea({Key? key}) : super(key: key);
  ...
  String _findRecentActivityDates(
    ...
    int index,
      ...
      _appDateFormat.monthAndDayOnly.format(_correctTheRecentActivityList(state)
          .elementAt(index)
          .createdActivityDynamic
          .createdAt);
