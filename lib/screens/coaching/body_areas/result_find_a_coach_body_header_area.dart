...
class ResultFindACoachBodyHeaderArea extends StatelessWidget {
  final AppFunctions _appFunctions = AppFunctions();
  final DateFormat _displayedDateFormat = AppDateFormat().displayedDateFormat;
  final double screenWidth;

  ResultFindACoachBodyHeaderArea({
  ...
  Widget build(BuildContext context) {
    final activityTypeDynamicButtonOnFindACoachScreenBloc =
        BlocProvider.of<ActivityTypeDynamicButtonOnFindACoachScreenBloc>(
            context);

    return CustomColumn(
      children: [
        _displayHeader(
            context, activityTypeDynamicButtonOnFindACoachScreenBloc),
        CustomAppDivider(),
  ...
  AppHeaderText _displayActivityTypeDynamicText(
    ...
    ActivityTypeDynamicButtonOnFindACoachScreenBloc
      ...
      AppHeaderText(
          textLabel: activityTypeDynamicButtonOnFindACoachScreenBloc
