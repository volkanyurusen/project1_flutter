...
class ChosenCoachBodyStartConversationArea extends StatelessWidget {
  const ChosenCoachBodyStartConversationArea({
    Key? key,
  }) : super(key: key);
  ...
  CustomElevatedButton _createStartConversationArea() {
    return CustomElevatedButton(
        ...
        onPressed: () {
          /// Here will be a function which starts a conversation between the coach and the app user.
