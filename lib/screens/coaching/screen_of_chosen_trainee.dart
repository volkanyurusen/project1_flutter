...
class ScreenOfChosenTrainee extends StatelessWidget {
  static const String routeName = 'screen_of_chosen_trainee';

  const ScreenOfChosenTrainee({Key? key}) : super(key: key);
  ...
  // /// TRAINING PICTURE =================================================================================================
  // _createTraineePhotoOnTop(BuildContext context) => PreferredSizeForPicture(
  //     context: context,
  //     child: AppBar(
  ...
  //     chosenState.chosenResponseAmongThoseWhoRespondedTrainingOffer.last
  ...
  //         ChosenResponseAmongThoseWhoRespondedTrainingOfferState chosenState) =>
  //     NetworkImage(chosenState.chosenResponseAmongThoseWhoRespondedTrainingOffer
  //         .last.traineeDynamic.picUrl);
  ...
  //             context, chosenResponseAmongThoseWhoRespondedTrainingOfferCubit, headline2),
  //         // follow button
  ...
  //         headerLabel: chosenResponseAmongThoseWhoRespondedTrainingOfferCubit
  //             .state
  //             .chosenResponseAmongThoseWhoRespondedTrainingOffer
  //             .last
  //             .coachDynamic
  ...
  //             'nearly ${chosenResponseAmongThoseWhoRespondedTrainingOfferCubit.state.chosenResponseAmongThoseWhoRespondedTrainingOffer.last.distanceBetween.round().toString()} km',
  ...
  //             followingState.userFollowingDynamicByIndividualUserList,
  //             chosenState.chosenResponseAmongThoseWhoRespondedTrainingOffer.last.coachDynamic
  //                 .userDynamic.uId!
  //                 .toInt());
  ...
  //     AppHeaderText(
  //         textLabel:
  //             '${chosenState.chosenResponseAmongThoseWhoRespondedTrainingOffer.last.coachDynamic.userDynamic.aboutUser} Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris',
