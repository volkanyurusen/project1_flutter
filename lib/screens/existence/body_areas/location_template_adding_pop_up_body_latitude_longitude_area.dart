...
class LocationTemplateAddingPopUpBodyLatitudeLongitudeArea
    extends StatelessWidget {
  final AppColors _appColors = AppColors();
  final AppTextConstants _appTextConstants = AppTextConstants();

  final TextfieldOfLatitudeLongitudeOnLocationTemplateAddingPopUpBloc
  ...
  LocationTemplateAddingPopUpBodyLatitudeLongitudeArea({
    required this.textfieldOfLatitudeLongitudeOnLocationTemplateAddingPopUpBloc,
  ...
  /// BUILD ============================================================================================================
  BlocBuilder<TextOfLatitudeLongitudeOnLocationTemplateAddingPopUpBloc,
  ...
  Expanded _displayTemplateNameText(
          TextOfLatitudeLongitudeOnLocationTemplateAddingPopUpState state) =>
      Expanded(
        child: AppHeaderText(
  ...
  /// BUILD ============================================================================================================
  BlocBuilder<TextfieldOfLatitudeLongitudeOnLocationTemplateAddingPopUpBloc,
  ...
  NameTextField _displayTemplateNameTextField(
    BuildContext context,
    TextfieldOfLatitudeLongitudeOnLocationTemplateAddingPopUpState state,
  ) =>
      NameTextField(
  ...
  void _getExistingTemplateName(BuildContext context) {
    context
        .read<TextfieldOfLatitudeLongitudeOnLocationTemplateAddingPopUpBloc>()
        .add(TextfieldOfLatitudeLongitudeOnLocationTemplateAddingPopUpSubmit(
  ...
  void _clickCancelButton(
    ...
    Future.delayed(
      ...
      () {
        textfieldOfLatitudeLongitudeOnLocationTemplateAddingPopUpBloc.add(
            TextfieldOfLatitudeLongitudeOnLocationTemplateAddingPopUpSubmit(
  ...
  void _clickAddButton(
    ...
    _closePopUp(dialogContext);
    dialogContext
        .read<TextOfLatitudeLongitudeOnLocationTemplateAddingPopUpBloc>()
        .add(TextOfLatitudeLongitudeOnLocationTemplateAddingPopUpSubmit(
            _findText(state)));
  }
