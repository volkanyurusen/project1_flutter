...
class LocationTemplateAddingPopUpBodyCancelAndAddArea extends StatelessWidget {
  ...
  void _cleanTemplateName(
    ...
    context
        .read<TextOfLocationTemplateNameOnLocationTemplateAddingPopUpBloc>()
        .add((TextOfLocationTemplateNameOnLocationTemplateAddingPopUpClear()));
  ...
  void _cleanLatitudeLongitude(
    ...
    context
        .read<TextOfLatitudeLongitudeOnLocationTemplateAddingPopUpBloc>()
        .add((TextOfLatitudeLongitudeOnLocationTemplateAddingPopUpClear()));
    textfieldOfLatitudeLongitudeOnLocationTemplateAddingPopUpBloc
        .add(TextfieldOfLatitudeLongitudeOnLocationTemplateAddingPopUpClear());
  }
  ...
  void _cleanAllButton(BuildContext context) {
    _cleanTemplateName(context,
        textFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpBloc);
    _cleanLatitudeLongitude(
        context, textfieldOfLatitudeLongitudeOnLocationTemplateAddingPopUpBloc);
  }
