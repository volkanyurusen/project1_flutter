...
class ApproveAttendeePopUp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _createApproveAttendeePopUp(context);
  }

  // APPROVE POP UP ====================================================================================================
  // CREATE ===========================================================================================================
  ActionPopUp _createApproveAttendeePopUp(BuildContext context) => ActionPopUp(
