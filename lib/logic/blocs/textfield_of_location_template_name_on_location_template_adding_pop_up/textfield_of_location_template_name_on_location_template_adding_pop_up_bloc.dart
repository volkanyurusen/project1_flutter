...
part 'textfield_of_location_template_name_on_location_template_adding_pop_up_event.dart';
part 'textfield_of_location_template_name_on_location_template_adding_pop_up_state.dart';

class TextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpBloc
    extends Bloc<
        TextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpEvent,
  ...
  TextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpBloc()
      : super(
            TextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpState()) {
    on<TextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpSubmit>(
        _onTextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpEvent);
    on<TextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpClear>(
        _onTextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpClear);
    on<TextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpCompleted>(
        _onTextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpCompleted);
  }
  ...
  FutureOr<void>
      _onTextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpEvent(
          TextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpSubmit
              event,
          Emitter<TextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpState>
              emit) {
    // BEGINNING STATE
    if (state.fieldText == '' &&
  ...
  FutureOr<void>
      _onTextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpCompleted(
          TextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpCompleted
              event,
          Emitter<TextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpState>
              emit) {
    emit(state.copyWith(
  ...
  FutureOr<void>
      _onTextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpClear(
          TextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpClear
              event,
          Emitter<TextFieldOfLocationTemplateNameOnLocationTemplateAddingPopUpState>
              emit) {
    emit(state.copyWith(
