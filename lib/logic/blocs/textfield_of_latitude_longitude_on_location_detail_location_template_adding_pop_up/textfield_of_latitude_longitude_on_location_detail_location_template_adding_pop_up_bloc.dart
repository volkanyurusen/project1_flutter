...
part 'textfield_of_latitude_longitude_on_location_detail_location_template_adding_pop_up_event.dart';
part 'textfield_of_latitude_longitude_on_location_detail_location_template_adding_pop_up_state.dart';

class TextfieldOfLatitudeLongitudeOnLocationDetailLocationTemplateAddingPopUpBloc
    extends Bloc<
        TextfieldOfLatitudeLongitudeOnLocationDetailLocationTemplateAddingPopUpEvent,
  ...
  TextfieldOfLatitudeLongitudeOnLocationDetailLocationTemplateAddingPopUpBloc()
      : super(
            TextfieldOfLatitudeLongitudeOnLocationDetailLocationTemplateAddingPopUpState()) {
    on<TextfieldOfLatitudeLongitudeOnLocationDetailLocationTemplateAddingPopUpSubmit>(
        _onTextfieldOfLatitudeLongitudeOnLocationDetailLocationTemplateAddingPopUpEvent);
    on<TextfieldOfLatitudeLongitudeOnLocationDetailLocationTemplateAddingPopUpClear>(
        _onTextfieldOfLatitudeLongitudeOnLocationDetailLocationTemplateAddingPopUpClear);
    on<TextfieldOfLatitudeLongitudeOnLocationDetailLocationTemplateAddingPopUpCompleted>(
        _onTextfieldOfLatitudeLongitudeOnLocationDetailLocationTemplateAddingPopUpCompleted);
  }
  ...
  FutureOr<void>
      _onTextfieldOfLatitudeLongitudeOnLocationDetailLocationTemplateAddingPopUpEvent(
          TextfieldOfLatitudeLongitudeOnLocationDetailLocationTemplateAddingPopUpSubmit
              event,
          Emitter<TextfieldOfLatitudeLongitudeOnLocationDetailLocationTemplateAddingPopUpState>
              emit) {
    // BEGINNING STATE
    if (state.fieldText == '' &&
  ...
  FutureOr<void>
      _onTextfieldOfLatitudeLongitudeOnLocationDetailLocationTemplateAddingPopUpCompleted(
          TextfieldOfLatitudeLongitudeOnLocationDetailLocationTemplateAddingPopUpCompleted
              event,
          Emitter<TextfieldOfLatitudeLongitudeOnLocationDetailLocationTemplateAddingPopUpState>
              emit) {
    emit(state.copyWith(
